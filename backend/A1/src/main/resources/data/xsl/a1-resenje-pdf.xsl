    ...
    <xsl:template match="/">
        <fo:root>
            <fo:layout-master-set>
                <fo:simple-page-master master-name="P1-resenje">
            ...
            <fo:page-sequence master-reference="P1-resenje">
                        ...
                        <fo:table-body>
                            ...
                            <fo:table-row>
                                <fo:table-cell padding="3px" number-columns-spanned="2">
                                    <fo:block>
                                        <fo:basic-link external-destination="http://localhost:8084/a1/download/pdf/{resenje_zahteva/sifra}">Referenca na zahtev</fo:basic-link>
                                    </fo:block>
                                </fo:table-cell>
                            </fo:table-row>
                        </fo:table-body>
