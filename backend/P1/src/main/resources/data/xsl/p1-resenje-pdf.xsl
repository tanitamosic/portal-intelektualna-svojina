            ...
            <fo:page-sequence master-reference="P1">
                <fo:flow flow-name="xsl-region-body">
                    ...
                    <fo:table table-layout="fixed" width="95%"
                        ...
                        <fo:table-body>
                            <fo:table-row border="1px solid black">
                                ...
                                <fo:table-cell padding="3px">
                                    <fo:block>TODO: PUT XPATH</fo:block>
                                </fo:table-cell>
                            </fo:table-row>
                            <fo:table-row border="1px solid black">
                                <fo:table-cell padding="3px">
                                    ...
                                    <fo:block>
                                        <xsl:element name="a">
                                            <xsl:attribute name="href">
                                                http://localhost:8083/download/pdf/ TODO: PUT XPATH
                                            </xsl:attribute>
                                            Referenca na zahtev
                                        </xsl:element>
                                    </fo:block>
                    ...
                    <fo:table table-layout="fixed" width="95%"
                        ...
                        <fo:table-body>
                            <xsl:choose>
                                <xsl:when test="TODO: PUT XPATH='false'">
                                    <fo:table-row>
                                        <fo:table-cell padding="3px">
                                ...
                                <xsl:otherwise>
                                    ...
                                    <fo:table-row>
                                        ...
                                        <fo:table-cell padding="3px">
                                            <fo:block>
                                                <xsl:value-of select="TODO: PUT XPATH"/>
                                            </fo:block>
                                        </fo:table-cell>
                                    </fo:table-row>
                                </xsl:otherwise>
